...
const EBookPaymentPage = () => {
    ...
    const submitPaymentHandler = async () => {
        ...
        try {
            ...
            await axios.post(`/api/ebooks/${id}/enroll`, { paymentScreenshot }, config);
            setEnrolling(false);
            alert('Payment submitted successfully! Your E-Book will be available soon.');

            // Navigate to Home replacing history, then immediately push My Courses
        ...
        <div className="pt-32 pb-20 min-h-screen bg-white dark:bg-darkBg transition-colors duration-300">
            <div className="container mx-auto px-6 max-w-3xl">
                <div className="bg-background dark:bg-darkCard rounded-3xl p-8 sm:p-12 shadow-sm border border-gray-100 dark:border-gray-800 text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-8 font-medium">You are buying: <span className="text-primary dark:text-accent font-bold">{ebook.title}</span> for ${ebook.price}</p>
